...
import sym_LFSR, asym_RSA, sym_AES, sym_ROT, hash_blake2b, hash_md5, sha1, sha2, sha3, sym_DES
import horse
...
class QuickCrypt(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, sym_LFSR.LFSR_gui, horse.horse_gui, asym_RSA.RSA_gui, sym_DES.DES_gui, sym_AES.AES_gui, sym_ROT.ROT_gui, hash_blake2b.BLAKE2_gui, hash_md5.MD5_gui, sha1.SHA1_gui, sha2.SHA2_gui, sha3.SHA3_gui):
